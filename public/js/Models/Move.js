...
Move = Backbone.Model.extend({
  ...
  expandCommand: function(match){
    ...
    if (match.match(/(\[[012346789]\])/g)){
      html.appendChild(makeImage("img/96_input_yellow_arrow.png","img-input rotate" + match[1]));
    }
    if (match.match(/(\[h[012346789]\])/g)){
      html.appendChild(mergeButtons(["img/96_input_yellow_arrow.png","img/96_hold.png"],["img-input rotate" + command[2],"img-input"]));
    }
    ...
    switch(match){
      ...
      case "[hp]":
        ...
        break;
      case "[k]":
        html.appendChild(makeImage("img/96_Kick.png","img-input"));
        break;
      case "[p]":
        html.appendChild(makeImage("img/96_Punch.png","img-input"));
        break;
      case "[2k]":
        html.appendChild(makeImage("img/96_2xKick.png","img-input"));
        break;
      case "[2p]":
        html.appendChild(makeImage("img/96_2xPunch.png","img-input"));
        break;
      case "[3k]":
        html.appendChild(makeImage("img/96_3xKick.png","img-input"));
        break;
      case "[3p]":
        html.appendChild(makeImage("img/96_3xPunch.png","img-input"));
        break;
      case "[214]":
        html.appendChild(makeImage("img/96_input_yellow_qcb.png","img-input"));
        break;
      case "[63214]":
        html.appendChild(makeImage("img/96_input_yellow_hcb.png","img-input"));
        break;
      case "[421]":
        html.appendChild(makeImage("img/96_input_yellow_rdp.png","img-input"));
        break;
      case "[236]":
        html.appendChild(makeImage("img/96_input_yellow_qcf.png","img-input"));
        break;
      case "[41236]":
        html.appendChild(makeImage("img/96_input_yellow_hcf.png","img-input"));
        break;
      case "[623]":
